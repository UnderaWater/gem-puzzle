const Game = {
    ...
    animate(e, time = 1) {
        let b1 = 0;
        let b2 = 0;
        let n1 = parseInt(e.style.gridArea[4]) - Game.properties.emptyPos[1];
        let n2 = parseInt(e.style.gridArea[0]) - Game.properties.emptyPos[0];
        if (n1 === 0) {
            if (n2 === 1) {
                b2 = -1;
            } else {
        ...
        e.style.top = pos2 + "px";
        let a1 = (pos1 + b1 * (2 + (0.7 * document.documentElement.scrollWidth + 0.7 * document.documentElement.scrollHeight) / (3 * Game.properties.size)));
        let a2 = (pos2 + b2 * (2 + (0.7 * document.documentElement.scrollWidth + 0.7 * document.documentElement.scrollHeight) / (3 * Game.properties.size)));
    ...
    createTable() {
        ...
        let arr = this.properties.leaderboard;
    ...
    showTime() {
        ...
        Game.properties.time[1] = Game.properties.time[1] + 1;
    ...
    showMsg() {
        ...
        newGameMsg = document.createElement("p");
